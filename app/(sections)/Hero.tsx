...
const Hero = () => {
  return (
    <main className="flex flex-col items-center justify-end h-[60vh] min-[250px]:h-[50vh] min-[290px]:h-[40vh] min-[330px]:h-[35vh] sm:h-[30vh] w-full text-center xl:px-30 lg:px-20 md:px-15 px-10 ">
