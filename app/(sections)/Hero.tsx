...
const Hero = () => {
  return (
    <main className="flex flex-col items-center justify-end h-[35vh] sm:h-[30vh] w-full text-center xl:px-30 lg:px-20 md:px-15 px-10 ">
        ...
        <p className="mt-4 md:text-lg text-[15px]">NextTools is a collection of tools to help you build your online empire. From social media management to e-commerce, we've got you covered.</p>
        <Link href={"/blog"}>
